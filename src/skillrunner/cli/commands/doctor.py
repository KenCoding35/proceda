...
from skillrunner.config import CONFIG_FILENAMES, CONFIG_SEARCH_PATHS, SkillRunnerConfig
...
def doctor() -> None:
    ...
    # Render table
    table = Table(title="SkillRunner Doctor")
